...
поиск ценных бумаг. Используя поиск, вы сможете получить список JSON
-подобных данных о ценных бумагах по ключевым словам. Это ключевое слово может быть именем
